...
UserInterface::UserInterface() {
  { mainWindow = new Fl_Double_Window(1680, 610, "NDI RIST Encoder");
    mainWindow->user_data((void*)(this));
    { topMenu = new Fl_Menu_Bar(0, 0, 1680, 20);
    ...
    { Fl_Group* o = new Fl_Group(385, 41, 225, 194, "Output");
      ...
      { upscaleInput = new Fl_Check_Button(390, 201, 25, 34, "Upscale");
        upscaleInput->down_box(FL_DOWN_BOX);
        upscaleInput->callback((Fl_Callback*)upscale_cb);
      } // Fl_Check_Button* upscaleInput
      { reencodeBitrateInput = new Fl_Input(390, 151, 220, 25, "Reencode Bitrate");
    ...
    { btnStartStream = new Fl_Button(740, 213, 95, 22, "Start Stream");
      btnStartStream->callback((Fl_Callback*)startStream_cb);
    } // Fl_Button* btnStartStream
    { btnStopStream = new Fl_Button(640, 213, 93, 22, "Stop Stream");
    ...
    { logDisplay = new Fl_Text_Display(21, 257, 1639, 171, "Log");
    } // Fl_Text_Display* logDisplay
    { ristLogDisplay = new Fl_Text_Display(22, 442, 1638, 161, "RIST Log");
